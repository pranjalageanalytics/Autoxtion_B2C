	...
	$("#button_submit").click(function() {
      ...
      // new Date(dd/mm/yyyy)
		...
		flag=true;
               ...
               if(id_vehicle.value==""){
			   document.getElementById('error_veh').innerHTML=" This field is required!";
				document.getElementById("id_vehicle").style.borderColor = "#E34234";
			   flag=false;   
			  }
			  else{
				  $("#error_veh").hide();
				  document.getElementById("id_vehicle").style.borderColor = "#ccc";  
			  }
